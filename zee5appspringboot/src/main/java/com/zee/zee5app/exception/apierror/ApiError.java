...
//should provide collective information regd errors
	private HttpStatus httpStatus;
	@JsonFormat(shape = JsonFormat.Shape.STRING,pattern = "dd-MM-yyyy hh:mm:ss")
	private LocalDateTime timeStamp;
	private String message;
	private String debugMessage;
	private List<ApiSubError> subErrors; //to hold validation relational errors
	private ApiError()
	{
		timeStamp=LocalDateTime.now();//@time when the method is called
	}
	...
	public void addValidationErrors(List<FieldError> fieldErrors)
	{
		...
		fieldErrors.forEach(e->addValidationError(e));
		//both lines are same
	}
